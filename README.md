<p align="center">
  ...
  <a href="https://www.python.org/">
    <img src="https://img.shields.io/static/v1?label=Python&message=3.11&color=blue&style=flat&logo=python">
  </a>
</p>
...
Custom Red cogs for the `Scruffy` Discord bot on the Guild Wars 2 University Discord server. 
...
`[p]repo add gwu-cogs https://github.com/Guild-Wars-2-University/gwucogs`

Then, install the cogs by running `[p]cog install gwu-cogs <name_of_cog>`
...
As such I am under no obligation to support it in any way. If you have any complaints or issues with the cogs, please take your frustration out on your computer by smashing the keyboard. Thank you.
